...
mod tests {
    ...
    use super::*;
    use crate::cli::chat::{context::AMAZONQ_FILENAME, tool_manager::ToolManager};
    ...
    async fn test_conversation_state_history_handling_truncation() {
        ...
        let mut conversation_state = ConversationState::new(Context::new_fake(), tool_manager.load_tools().await.unwrap(), None).await;
